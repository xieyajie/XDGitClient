...
#import "DXActivityIndicatorView.h"
...
@property (strong, nonatomic) DXActivityIndicatorView *activityIndicatorView;
...
- (UIView *)loadingView
{
    if (_loadingView == nil) {
        ...
        if (_activityIndicatorView == nil) {
            _activityIndicatorView = [[DXActivityIndicatorView alloc] initWithFrame:CGRectMake(5, 0, KTIWidth - 10, KIndicatorHeight) ballColor:[UIColor colorWithRed:0.47 green:0.60 blue:0.89 alpha:1]];
