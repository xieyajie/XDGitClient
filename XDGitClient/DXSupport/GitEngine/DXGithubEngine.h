...
typedef enum{
    DXRequestMothodGet,
    DXRequestMothodPost,
    DXRequestMothodDelete,
}DXRequestMothod;

@interface DXGithubEngine : NSObject
{
...
- (AFHTTPRequestOperation *)eventsForIssue:(NSInteger)issueId
                             forRepository:(NSString *)repositoryPath
                                   success:(XDGitEngineSuccessBlock)successBlock
                                   failure:(XDGitEngineFailureBlock)failureBlock;
...
- (AFHTTPRequestOperation *)notificationsWithSuccess:(XDGitEngineSuccessBlock)successBlock
                                             failure:(XDGitEngineFailureBlock)failureBlock;

- (AFHTTPRequestOperation *)notificationsForRepository:(NSString *)repositoryPath
                                               success:(XDGitEngineSuccessBlock)successBlock
                                               failure:(XDGitEngineFailureBlock)failureBlock;
...
- (AFHTTPRequestOperation *)followers:(NSString *)user
                                 page:(int)page
                              success:(XDGitEnginePageSuccessBlock)successBlock
                              failure:(XDGitEngineFailureBlock)failureBlock;
